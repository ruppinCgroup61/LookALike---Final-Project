...
function UploadItem() {
  ...
  const GetAllColors = () => {
    fetch("https://proj.ruppin.ac.il/cgroup61/test2/tar1/api/Colors", {
      method: "GET",
      headers: {
  ...
  const SubmitUpload = (event) => {
    ...
    if (isBusi == "false") {
      fetch("https://proj.ruppin.ac.il/cgroup61/test2/tar1/api/Item", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      const url = `https://proj.ruppin.ac.il/cgroup61/test2/tar1/api/PopupDetails/InsertItemToPopUp?popUpId=${pID}&userMail=${encodeURIComponent(
        UserEmail
      )}`;
  ...
  const GetAllBrands = () => {
    fetch("https://proj.ruppin.ac.il/cgroup61/test2/tar1/api/Brand", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const GetAllClothingTypes = () => {
    fetch("https://proj.ruppin.ac.il/cgroup61/test2/tar1/api/ClothingType", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
      },
